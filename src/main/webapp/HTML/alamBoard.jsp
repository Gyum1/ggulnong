...
<div class="container">
    <section class="box">
        <aside class="box-sidebar">
            ...
            <div class="side">
                <ul class="side-menu">
                    <li class="on"><a href="alamBoard.jsp" >공지사항</a></li>
                    <li><a href="noteBoard.jsp" >자유게시판</a></li>
                </ul>
            </div>
        </aside><!--사이드 메뉴 end-->
        ...
        <div class="box-contents">
            ...
            <div class="write-btn">
                <button type="button" id="btn_write" class="btn_write" onclick="location.href='alamWrite.jsp'">글쓰기</button>
            </div><!--상단 end-->
