    ...
    <nav>
      ...
      <div class="nav-fir">
        ...
        <div class="nav-sidebar-box">
          ...
          <div class="sidebar">
            <ul class="sidebar-ul">
              <li><a href="../../HTML/alamBoard.jsp">알림/소식</a>
                <ul class="sidebar-li">
                  <li><a href="../../HTML/alamBoard.jsp">공지사항</a></li>
                  <li><a href="../../HTML/noteBoard.jsp">게시판</a></li>
                </ul>
              </li>
              <li><a href="../../HTML/machineRental.jsp">농기구</a>
                <ul class="sidebar-li">
                  <li><a href="../../HTML/machineRental.jsp">기구 대여</a></li>
                </ul>
              </li>
              ...
              <li><a href="../../HTML/html/useExBoard.html">이용안내</a>
                <ul class="sidebar-li">
